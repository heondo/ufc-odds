...
router.get('/:id', async (req, res, next) => {
  try {
    ...
    // queryResponse.rows.forEach(summ => {
    //   summ.markets = summ.markets ? JSON.parse(summ.markets) : null;
    // });
    res.status(200);
    res.json({
      success: true,
